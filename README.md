...
Todo projeto que desenvolvo segue uma metodologia estruturada baseada nos princípios de **Design Thinking** e **Design de Serviços**.
...
Python • FastAPI • Flask • SQLite • Git • GitHub • Jinja2 • OpenAI • Claude • Gemini • Pillow • PyPDF2 • FFmpeg
...
Profissionais independentes frequentemente possuem excelente conhecimento técnico em suas áreas, mas enfrentam dificuldades para estruturar seus negócios, desenvolver uma identidade de marca consistente e organizar sua comunicação digital.

Esses desafios resultam em perda de produtividade, comunicação inconsistente e dificuldade de posicionamento no mercado.

## Pesquisa

Durante o desenvolvimento da solução foram identificadas necessidades recorrentes entre profissionais independentes:

- Dificuldade na criação de conteúdo;
...
Python • Flask • OpenAI • Claude • Gemini • Pillow
...
A análise de processos de pensão por morte exige consulta constante à legislação, conferência documental, cálculos previdenciários e verificação da autenticidade dos documentos.
...
Python • FastAPI • Hash SHA-256 • PyPDF • pdfplumber • Jinja2
...
Essa vivência, aliada ao desenvolvimento de soluções digitais baseadas em Inteligência Artificial, permite unir visão estratégica, conhecimento técnico e foco no usuário para criar produtos inovadores e eficientes.

Tenho facilidade para compreender problemas complexos, estruturar soluções e transformá-las em produtos digitais que geram valor para pessoas e organizações.
...
💼 **GitHub:** https://github.com/ssinara830-lgtm
